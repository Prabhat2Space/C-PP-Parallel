...
//
  ...
  {
    cout << "  Process " << id << " had nothing to do.\n";
    MPI_Finalize ( );
  }
  return 0;
}
...
//
{
  ...
  {
    cout << "\n";
    cout << "P0_SEND_INPUT - Fatal error!\n";
    cout << "  MPI_Send returned ierr = " << ierr << "\n";
    exit ( 1 );
  }
...
//
    ...
    {
      cout << "\n";
      cout << "P0_RECEIVE_OUTPUT - Fatal error!\n";
      cout << "  MPI_Recv returned ierr = " << ierr << "\n";
      exit ( 1 );
    }
//
...
//
{
  ...
  {
    cout << "\n";
    cout << "P1_RECEIVE_INPUT - Fatal error!\n";
    cout << "  MPI_Recv returned ierr = " << ierr << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  {
    cout << "\n";
    cout << "P1_SEND_OUTPUT - Fatal error!\n";
    cout << "  MPI_Send returned ierr = " << ierr << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  {
    cout << "\n";
    cout << "P2_RECEIVE_INPUT - Fatal error!\n";
    cout << "  MPI_Recv returned ierr = " << ierr << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  {
    cout << "\n";
    cout << "P2_SEND_OUTPUT - Fatal error!\n";
    cout << "  MPI_Send returned ierr = " << ierr << "\n";
    exit ( 1 );
  }
